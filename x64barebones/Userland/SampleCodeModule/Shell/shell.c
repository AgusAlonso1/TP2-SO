...
char * commands[AMOUNT_OF_COMMANDS] = {"help", "time", "registers", "snake", "div0", "invalidop", "clear", "zoomin", "zoomout", "settheme", "EstoesBoca", "loop", "ps", "kill", "nice", "block", "minfo", "testmm", "testprocesses", "testprio", "testsync", "cat", "wc", "filter", "phylos"};
...
int (* commandsReferences[AMOUNT_OF_COMMANDS])(int, char **) = {(int (*)(int, char **)) man,
                                                                ...
                                                                test_mm,
                                                                test_processes,
                                                                (int (*)(int, char **)) test_prio, test_sync, cat, wc, filter, phylos};
