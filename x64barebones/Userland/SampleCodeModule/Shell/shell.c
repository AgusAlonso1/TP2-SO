...
char * commands[AMOUNT_OF_COMMANDS] = {"man", "time", "registers", "snake", "div0", "invalidop", "clear", "zoomin", "zoomout", "settheme", "EstoesBoca", "loop", "ps", "kill", "nice"};
int (* commandsReferences[AMOUNT_OF_COMMANDS])(int, char **) = {(int (*)(int, char **)) man,
                                                                ...
                                                                (int (*)(int, char **)) theme,
                                                                (int (*)(int, char **)) printBoca, loop, ps, kill, nice};
